...
function init3D()
{
	...
	//const hemilight = new THREE.HemisphereLight( 0xffffbb, 0x080820, 0.1 );
	//scene.add( hemilight );
...
$("#feedbackRequest").click(function(){
	...
	reader.readAsDataURL(new Blob([s2ab(objects)],{type:"application/octet-stream"}));
